...
class Weather(Producer):
    ...
    def __init__(self, month):
        ...
        #
        #
        self.topic_name = "com.udacity.extra.weather"
        super().__init__(
            self.topic_name,
    ...
    def run(self, month):
        ...
        resp = requests.post(
           #
           #
           # What URL should be POSTed to?
           #
           #
           f"{Weather.rest_proxy_url}/topics/{self.topic_name}",
           #
           #
           # What Headers need to bet set?
           #
           #
           ...
           data=json.dumps(
               {
                   ...
                   "records": [
                       {"value": {"temperature": self.temp, "status": self.status.name }, "key": {"timestamp": int(round(time.time() * 1000))}}
                   ]
               }
           ),
        )
